...
export class WasmSolver {
    ...
    */
    solve(initial, unique) {
        const ret = wasm.wasmsolver_solve(this.__wbg_ptr, initial, unique);
    ...
    * @returns {any[]}
    */
    represent_solution(solutions) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            _assertClass(solutions, Solutions);
            var ptr0 = solutions.__destroy_into_raw();
            wasm.wasmsolver_represent_solution(retptr, this.__wbg_ptr, ptr0);
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('pentomino_solver_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
